...
import { isOwnerAccountBalanceLoaded, isWeb3Initialized, ownerAccountBalance } from 'src/app/omnifan/store/omnifan.selectors';
...
@Component({
  selector: 'app-omnicollectible-add',
  templateUrl: './omnicollectible-add.component.html',

})
export class OmniCollectibleAddComponent implements OnInit {
